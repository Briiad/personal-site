...
const ProjectCard = ({project}) => {
  return (
    <motion.div whileHover={{scale:1.05}} className='w-54 h-72 md:w-80 md:h-80 flex flex-col justify-between bg-main-400 md:bg-main-400/70 rounded-md p-4 overflow-hidden'>
      ...
      <div className='h-3/5 p-4 z-0'>
        <div className='text-md font-bold text-primary mb-4'>
          <h1 className='text-main-100 text-base md:text-xl text-transparent bg-clip-text bg-gradient-image-pp'>
