  ...
  return (
    <div className='relative w-full h-auto md:h-screen p-6 md:p-12 grid grid-cols-1 md:grid-cols-6 '>
      <div className='w-full h-full col-span-3 flex justify-center items-center '>
        <div className='flex flex-col p-6 pt-20 md:pt-0 md:p-12 text-main-100 select-none'>
          <h1 className='text-7xl md:text-8xl'>I'm <span className='text-shadow-css'>Brian.</span></h1>
          ...
          <p className='my-8 text-sm md:text-base text-justify'>
